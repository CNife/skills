...
可进行对话式问答的 AI 站点。当用户没有指定平台时，优先从以下选择一个。

### 首选（三选一）

| 站点 | 适用场景 | 语境 |
|------|----------|------|
| `grok` | 实时热点、Twitter/X 语境、英文互联网舆论 | 英文、实时 |
| `doubao` | 中文语境、国内热点、生活方式、字节生态 | 中文、国内 |
| `gemini` | 全球网页、英文资料、背景综述、通用检索 | 英文、通用 |
...
**选择原则：** 先判断语言和语境，从首选三选一。不要并行跑多个 AI 源。若首选结果不足，可考虑换一个备选源，但需要明确说明为什么首选不够用。
...
- 求职：`<岗位> + <城市> + market trends/hiring + <时间范围>`
